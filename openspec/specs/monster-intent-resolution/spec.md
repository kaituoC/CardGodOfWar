...
## Purpose
Defines how stored monster intents execute during the monster action, how defensive intent skills affect hero actions, weak/shield application, and intent refresh after resolution.
## Requirements
