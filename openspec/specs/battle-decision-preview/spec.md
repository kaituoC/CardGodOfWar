# Battle Decision Preview

## Purpose
Defines how the battle UI previews monster intent, Boss pressure, and per-card outcome estimates, and the consistency guarantees between preview and engine execution.
## Requirements
