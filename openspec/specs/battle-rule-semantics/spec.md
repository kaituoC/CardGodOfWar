# Battle Rule Semantics

## Purpose
Defines combat rule semantics: the canonical turn sequence and the deterministic order in which defense, break-defense, element, crit, shield, weak, relic, and enrage modifiers resolve.
## Requirements
